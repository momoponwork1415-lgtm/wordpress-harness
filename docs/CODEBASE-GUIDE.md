...
| Restricted Claude Finder and structured role execution | partial, internal; optional Source Evidence MCP implemented | `ModelExecution.run` / `StructuredModelExecution.run` | [`model-execution/index.ts`](../src/research/model-execution/index.ts), [`model-execution.ts`](../src/research/model-execution/model-execution.ts), [`claude-process.ts`](../src/research/model-execution/claude-process.ts) | [`model-execution.test.ts`](../tests/research/model-execution.test.ts), [`structured-model-execution.test.ts`](../tests/research/structured-model-execution.test.ts), [`claude-source-evidence-bridge.test.ts`](../tests/research/claude-source-evidence-bridge.test.ts) | [Model execution seam](design/model-execution-seam.md) |
...
| Model Execution | partial | Finder schema、provider-neutral structured role bridge、共有Claude process、version/auth probe、budget/process-group終了、provider envelope policy監査、bounded provider error detail、private Finder result CAS、Attempt-bound Source Evidence callbackとquery ceiling、private loopback Claude MCP bridge | [Model execution seam](design/model-execution-seam.md) |
