...
| Verification | partial | `verify(plan)`、Stored XSS Finding/Disproved、gVisor Blocked、typed Witness/Control、durable outcome replay | [Verification seam](design/verification-seam.md) |
