...
| 内容 | Source | 現在の関係 |
| --- | --- | --- |
| base Prompt | [WP2Shell-derived](../prompts/wordpress-plugin-research-v3.md) / [Cloudflare-derived](../prompts/wordpress-plugin-research-cloudflare-v1.md) | `research-methods.ts`がcanonical method idと本文digestをbindする。CLIから選択した本文を渡し、sealed digestを検査する |
