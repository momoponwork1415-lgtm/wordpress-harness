...
| **verify** | concrete CandidateをResearch内でadversarialに反証し、Human Candidate Reviewで採用されたものだけをfresh isolated Candidate Verificationへ渡す。 |
