...
| --- | --- | --- |
| `wp2shell` | `wordpress-plugin-research-wp2shell-v4` / [Prompt](../prompts/wordpress-plugin-research-v4.md) | 十分に異なる探索経路、複数回の反復、遅い知見の交差、繰り返しの統合と方向転換 |
