...
- **Target Intelligence -> Research**: Target IntelligenceはAIがoracle-freeなTarget Proposalを作り、人間のApproved Target Batchへまとめ、実行直前のfreshness確認と取得後に`Target Intake Packet`だけをdispatchする。Researchは選定理由を再評価しない。
